...
// Function to add the copy icon to messages
function addCopyIconToMessages(){
    ...
    messages.forEach(message => {
        ...
        copyButton.style.background= '#040608f'

        copyButton.style.width=32
        copyButton.style.width=32
        ...
        // Append your copy icon button to the existing icon container
...
// document.addEventListener('DOMContentLoaded', addCopyIconToMessages());
